            ...
            <div class="d-flex flex-wrap justify-content-center">
                ...
                {{-- <div class="card bg-light mb-3 text-gray-400 border-0 p-2 px-4 rounded-0 col-11 col-md-4">
                    <div class="card-body bg-white border rounded-0 ">
                        ...
                        <p class="card-text">
                            <address>
                                189/2, Boubazar, Badda,Dhaka-1212
                            </address>
                        </p>
                        <p>
                            Contact at :- <a href="mailto:koushik@gmail.com"> koushik@gmail.com</a>
                        </p>
                        <p class="text-right pt-4 px-3">
                ...
                <div class="card bg-light mb-3 text-gray-400 border-0 p-2 px-4 rounded-0 col-11 col-md-4">
                    <div class="card-body bg-white border rounded-0 ">
                        ...
                        <p>
                            Contact at :- <a href="mail to:koushik@gmail.com"> koushik@gmail.com</a>
                        </p>
                        <p class="text-right pt-4 px-3">
                            <a href="http://" class="btn rounded-0 btn-danger">
                            Request Blood
